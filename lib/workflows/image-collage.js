export async function GenerateImageCollage(hyper, idea) {
    const h = hyper.begin();
    h.updateState({ idea });
    h.tell(`
    ...
    await h.generateImagesFromImages(Object.values(h.state.prompts).map(a => ({ imageUrl: baseImage.accessUrl, prompt: a, strength: 0.15 })));
}
//# sourceMappingURL=image-collage.js.map